...
(function () {
 ...
 // Inline SVG icon (forced white color)
  ...
  .cbt-btn{
    ...
    border:1px solid rgba(8,61,72,.20);
    box-shadow:0 6px 20px rgba(0,0,0,.18);

    cursor:pointer; z-index:9999;
    transition:transform .2s ease, box-shadow .2s ease, filter .2s ease;
  }
  .cbt-btn:hover{ transform:scale(1.2); box-shadow:0 8px 24px rgba(0,0,0,.22); filter:brightness(1.05); }
  ...
  /* Chatbot panel */
  .cbt-panel{
    position:fixed; left:16px; bottom:76px; width:400px;height:70vh; max-height:70vh;
  ...
  .cbt-msg.me{ color: #083d48; font-weight:500; }
  ...
  .cbt-foot button{
    ...
    background:  #083d48; color:#fff; font-weight:500; cursor:pointer;
